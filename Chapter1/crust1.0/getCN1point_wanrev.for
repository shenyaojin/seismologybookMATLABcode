	...
	open(55,file='pointmodel.dat')

      print*,' .... reading all maps ... ' 

      do j=1,nla
         do i=1,nlo
            read(51,*,end=1)(vp(k,j,i),k=1,np)
            read(52,*,end=1)(vs(k,j,i),k=1,np)
            read(53,*,end=1)(rho(k,j,i),k=1,np)
            read(54,*,end=1)(bnd(k,j,i),k=1,np)
         enddo
      enddo
      close(51)
      close(52)
...
!      print 102,'ilat,ilon,crustal type: ',ilat,ilon
	write(55,'(a,2f10.4)') 'Latitude and Longtitude are:'
     &	,flat,flon
      write(55,102)'ilat,ilon,crustal type: ',ilat,ilon
 102  format(a,2i4)
!      print*,'topography: ',bnd(1,ilat,ilon)
      write(55,*)'topography: ',bnd(1,ilat,ilon)
!      print*,' layers: vp,vs,rho,bottom'
      write(55,*)' layers: vp,vs,rho,bottom'
 103  format(4f7.2)
      do i=1,np-1
!         print 103,vp(i,ilat,ilon),vs(i,ilat,ilon),rho(i,ilat,ilon),
!     +          bnd(i+1,ilat,ilon) 
         write(55,103)vp(i,ilat,ilon),vs(i,ilat,ilon),rho(i,ilat,ilon),
     +          bnd(i+1,ilat,ilon) 
      enddo
!      print 104,' pn,sn,rho-mantle: ',vp(9,ilat,ilon),
!     +         vs(9,ilat,ilon),rho(9,ilat,ilon)
      write(55,104)' pn,sn,rho-mantle: ',vp(9,ilat,ilon),
     +         vs(9,ilat,ilon),rho(9,ilat,ilon)
 104  format(a,3f7.2)
      goto 1
 99   continue
